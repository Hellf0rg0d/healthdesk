...
import { Video, FileText, Bot, Search, HeartPulse, Network } from "lucide-react";
...
export default async function PatientDashboard({ params }) {
  ...
  const patName = resolvedParams?.patName;
  ...
  if (name !== patName) {
    redirect(`/dashboard/patient/${name}`);
  }
  ...
  const features = [
    {
      ...
      description:
        "Connect with doctors through secure video calls for remote consultations and medical advice.",
      icon: Video,
      href: `/consultation`,
    },
    {
      ...
      description:
        "Get instant answers to health questions and personalized health insights from our AI helper.",
      icon: Bot,
      href: `/medicalAssistant`,
    },
    {
      id: "MedReach",
      title: "MedReach",
    ...
    },
    {
      ...
      description:
        "Search for medicine availability in nearby pharmacies and get real-time stock updates.",
      icon: Search,
      href: `/medi-store/card`,
    },
    {
      id: "health-records",
      title: "Health Records",
      description:
        "Access and manage your complete medical history, test results, and health documents.",
      icon: FileText,
        ...
        <div className="rounded-2xl px-7 py-6 my-0 mx-auto mb-12 max-w-[850px] text-center">
          <div className="flex items-center justify-center gap-3 mb-3">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-slate-800">
              Hi {patName ?? "Friend"}, welcome back!
            </h2>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mt-2">
            We will be your Care That Listens, Care That Heals.
          </h1>
        </div>
