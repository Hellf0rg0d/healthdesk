  ...
  const features = [
    {
      ...
      description: "Chat with our intelligent medical assistant for instant health advice and symptom analysis.",
      icon: MessageCircle,
      href: '/medicalAssistant/chat'
    },
    {
      id: 2,
      title: "Health Prediction",
      description: "Get AI-powered health predictions and early warning signs based on your symptoms and data.",
      icon: Brain,
      href: '/medicalAssistant/predict'
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 leading-tight">
            AI Medical Assistant at{' '}
            <span className="text-cyan-600">Your Service</span>
          </h1>
          
          <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Get instant medical advice and health predictions powered by AI.
          </p>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <Link key={feature.id} href={feature.href}>
                <div
                  className="group relative bg-cyan-100 hover:bg-cyan-200 backdrop-blur-xl rounded-3xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border border-cyan-200 hover:border-cyan-400 hover:-translate-y-2 overflow-hidden cursor-pointer"
