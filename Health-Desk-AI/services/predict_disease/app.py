...
try:
    ...
    model_path = os.path.join(base_dir, "symptom_checker_model.joblib")
    columns_path = os.path.join(base_dir, "symptom_columns.joblib")
    ...
    print(f"Error: Model or column file not found. Details: {e}")
    print(f"Base directory: {base_dir if 'base_dir' in locals() else 'not set'}")
